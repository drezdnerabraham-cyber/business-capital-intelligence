# Fenmark Connect — static website

A four-page static site for **Fenmark Connect**, a service of **AFE International LLC**.
...
- [ ] If you register a hosted opt-in web form, the form at
      `apply.fenmarkconnect.net/apply` shows the same consent language and an **unchecked** consent
